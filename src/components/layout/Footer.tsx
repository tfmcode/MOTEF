...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-gray-50 to-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:py-16 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center mb-12 lg:mb-16">
          ...
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed max-w-2xl">
            ...
            acondicionado, piletas, artículos de auto y electrodomésticos. Los
            mejores productos al mejor precio.
          </p>

          <div className="flex gap-3 mt-6">
            {/* INICIO - Corregido: Faltaba la etiqueta <a> de apertura */}
            <a
              href="https://www.instagram.com/motef.tech.arg/?hl=es"
              target="_blank"
            ...
            {/* FIN - Corregido: Faltaba la etiqueta <a> de apertura */}

            {/* INICIO - Corregido: Faltaba la etiqueta <a> de apertura */}
            <a
              href="https://www.youtube.com/@motefTechAR"
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* INICIO - Corregido: Faltaba la etiqueta <a> de apertura */}
            <a
              href="https://www.tiktok.com/@motef.tech"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12 max-w-5xl mx-auto">
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-3">
              {[
                ...
                {
                  label: "Motocicletas",
                  href: "/productos?categoria=motocicletas",
                },
                {
                  label: "Bicicletas",
                ...
                },
                {
                  ...
                  href: "/productos?categoria=aire-acondicionado",
                },
                { label: "Piletas", href: "/productos?categoria=piletas" },
                { label: "Auto", href: "/productos?categoria=auto" },
                {
                ...
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="text-gray-600 hover:text-motef-primary transition-colors duration-200 inline-flex items-center gap-2 group text-sm"
                  >
                    <ArrowRight
                      size={14}
          ...
          <div className="text-center sm:text-left sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex flex-col items-center sm:items-start space-y-3 px-[15%] sm:px-0">
              {/* INICIO - Corregido: Faltaba la etiqueta <a> de apertura */}
              <a
                href="https://wa.me/5491168896621?text=Hola! Quiero consultar sobre los productos de MOTEF"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                ...
                className="flex items-center gap-3 text-gray-600 hover:text-motef-primary transition-colors duration-200 group w-full sm:w-fit"
              >
                <div className="w-11 h-11 flex-shrink-0 bg-motef-primary rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform shadow-md">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              >
                <div className="flex-shrink-0 text-motef-primary">
                  {item.icon}
                </div>
                <div>
      ...
      <div className="border-t border-gray-200 bg-gradient-to-br from-motef-primary via-orange-600 to-orange-700">
        <div className="max-w-7xl mx-auto px-4 py-10 sm:py-12 sm:px-6 lg:px-8">
          <div className="text-center">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
              ¿Buscás productos de calidad?
            </h3>
            <p className="text-orange-100 mb-6 text-sm sm:text-base max-w-2xl mx-auto">
              Explorá nuestro catálogo completo y encontrá todo lo que necesitás
              para tu vehículo, hogar y más
            </p>
            <Link
              href="/productos"
              className="inline-flex items-center gap-2 bg-white text-motef-primary px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold hover:bg-orange-50 transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105 text-sm sm:text-base"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs sm:text-sm text-gray-600">
            <p className="text-center md:text-left">
              © {currentYear} MOTEF. Todos los derechos reservados.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-motef-primary hover:text-motef-primary-dark font-medium transition-colors"
              >
